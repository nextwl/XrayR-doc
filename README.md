...
项目地址: [https://github.com/nextwl](https://github.com/nextwl)

## 项目目录

- [XrayR](https://github.com/nextwl/XrayR)：XrayR源码以及软件发布。
- [XrayR-release](https://github.com/nextwl/XrayR-release)：XrayR一键安装脚本以及Docker。
- [XrayR-doc](https://github.com/nextwl/XrayR-doc)：XrayR文档源码。
