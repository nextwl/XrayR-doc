...
确保v2board 版本 >= [1.7.0](https://github.com/v2board/v2board/releases/tag/1.7.0)，XrayR 版本>= [v0.8.8](https://github.com/nextwl/XrayR/releases/tag/v0.8.8)，`PanelType:`请选择 "NewV2board"。
